...
CFR (Community File Repository) is a new C*Tool made by [Webdetails](http://www.webdetails.pt) that allows you to setup and use a file repository from inside or outside Pentaho. You can use it to manage your file needs, allowing uploads and downloads from inside your dashboards. 
...
To create, delete, list or get files and folders there are some exposed inetrfaces you can use.  
...
Yes, we can build and execute a POST request specifying the correct options. For more details on this, please contact [Webdetails](http://www.webdetails.pt/) 
