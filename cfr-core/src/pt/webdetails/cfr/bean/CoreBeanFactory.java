...
public class CoreBeanFactory implements ICfrBeanFactory {

  public static final String CFR_SPRING_BEAN = "cfr.spring.xml";
  ...
  public CoreBeanFactory() {
    context = getSpringBeanFactory( CFR_SPRING_BEAN );
  }
  ...
  protected ConfigurableApplicationContext getSpringBeanFactory( String config ) {
    try {
      ...
      logger.fatal( "Error loading " + CFR_SPRING_BEAN, e );
    }
    logger.fatal(
